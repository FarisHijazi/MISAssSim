...
class AssembledFile:
    def __init__(self, text):
        ...
        self.directiveSegments = {
            ".text": List[Instruction],  # defines a text segment that contains read-only executable instructions
            ".data": List[DataBlock],  # defines a data segment that contains read/write data (can be read and written)
            ".stext": List[Instruction],  # defines a system text segment that contains system instructions
